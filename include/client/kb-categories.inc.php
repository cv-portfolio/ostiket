...
<?php
    ...
    if ($categories->exists(true)) { ?>
        <div><?php echo __("Haga clic en la categoría para explorar las preguntas frecuentes".); ?></div>
        <ul id="kb">
<?php
...
<?php
        ...
        echo __('NO se encontraron preguntas frecuentes');
    }
?>
</div>
<div class="span4">
...
<?php } ?>
    ...
    <div class="content">
        <section>
            <div class="header"><?php echo __('Otros recursos'); ?></div>
        </section>
    </div>
    </div>
</div>

...
foreach ($faqs as $F) {
    ...
    echo '<strong>'.__("Esta categoría no tiene preguntas frecuentes".).' <a href="index.php">'.__('Volver al índice').'</a></strong>';
}
?>
</div>
...
<div class="span4">
    ...
    <div class="searchbar">
        ...
        <input type="text" name="q" class="search" placeholder="<?php
            echo __('Buscar en nuestra base de conocimientos'); ?>"/>
